...
parallel_runtime_file="parallel_runtimes_sac.txt"
total_runtime_file="total_runtime_sac.txt"
...
for durchgang in $(seq $durchgaenge); do
    ...
    for i in $(seq $parallel); do
        ...
        python run_reaching_sac.py --id $y --save 1 --buffer_size 100000 &
    done
    wait
...
total_runtime=$(seconds_to_dhm $total_duration)
